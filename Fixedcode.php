...
if (isset($_POST["person"])) {
   $person = $_POST['person'];    //isset is linked 
} else {    
    echo "Add new user";
}
...
<body>
	...
	<?php
	 //Print 10 times
	 for ($i = 1; $i<=10; $i++) {
	  echo "<p>".$lipsum."</p>"; //should have use period instead of plus sign
	}
	?>
	...
	<?php if ($person): ?>
		...
		<?php echo $first = $person['first_name'];?>  
	...
	<table>
		...
		<tbody>
			<?php foreach ($people as $person): ?>
				<tr>
					<td><?php echo $first = $person['first_name'];?></td> <!-- the way of fecthing array was wrong --> 
